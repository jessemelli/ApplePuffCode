...
public class Scaling extends Subsystem {
	...
	**/
    ...
    public void initDefaultCommand() {
    	...
    	setDefaultCommand(new org.usfirst.frc.team5700.robot.commands.ReleaseScalingArm());
    }

	public void addDefault(String string, ReleaseScalingArm releaseScalingArm) {
